...
/* harmony import */ var _basket__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./basket */ "./src/js/modules/basket.js");
  ...
  _createClass(BurgerMenu, [{
    ...
    value: function init() {
      ...
      if (this.burgerButtons.length > 0 && this.burgerMenu) {
        this.burgerButtons.forEach(function (button, index) {
          button.addEventListener('click', function () {
            _this.toggleMenu(index);
          });
        });
      }
    }
    ...
    key: "bindSubMenuEvents",
    value: function bindSubMenuEvents() {
      var _this2 = this;
      var _loop = function _loop() {
        var _this2$subMenus$key = _this2.subMenus[key],
          menu = _this2$subMenus$key.menu,
          openButton = _this2$subMenus$key.openButton,
          closeButton = _this2$subMenus$key.closeButton;
        if (menu && openButton && closeButton) {
          openButton.addEventListener('click', function () {
            _this2.toggleSubMenu(menu);
          });
          closeButton.addEventListener('click', function () {
            menu.classList.remove('open');
            _this2.toggleScrollLock();
          });
        }
      };
    ...
    key: "toggleMenu",
    value: function toggleMenu(index) {
...
/***/ "./src/js/modules/BusketListItem.js":
/*!******************************************!*\
  !*** ./src/js/modules/BusketListItem.js ***!
  \******************************************/
/***/ (function(__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) {
...
/* harmony export */   AddItemToList: function() { return /* binding */ AddItemToList; },
/* harmony export */   ChangeItem: function() { return /* binding */ ChangeItem; },
...
function AddItemToList(id, name, price, amount, img, background) {
  var newItem = jquery__WEBPACK_IMPORTED_MODULE_0__("<div class=\"basket-list-item\" id=\"item-".concat(id, "\">\n  <picture class=\"basket-list-item__img\" style=\"background-color: ").concat(background, "\">\n    <source\n      srcset=\"").concat(img.avif, "\"\n      type=\"image/avif\"\n    />\n    <source\n      srcset=\"").concat(img.webp, "\"\n      type=\"image/webp\"\n    />\n    <img\n      src=\"").concat(img.png, "\"\n      alt=\"Ortho Complex\"\n    />\n  </picture>\n  <p class=\"basket-list-item__name\">\n    ").concat(name, "\n  </p>\n  <svg class=\"basket-list-item__delete\" id=\"").concat(id, "\">\n    <use xlink:href=\"/images/Sprite.svg#close\"></use>\n  </svg>\n  <div class=\"basket-list-item__amount\">\n   <div class=\"stepper-input\" id=\"stepper-").concat(id, "\">\n    <button class=\"stepper-input__button decrement\">-</button>\n    <div class=\"stepper-input__content\">\n        <input type=\"text\" id=\"amount-").concat(id, "\" class=\"stepper-input__input\" value=\"").concat(amount, "\" readonly aria-label=\"Amount\"/>\n    </div>\n    <button class=\"stepper-input__button increment\">+</button>\n</div>\n  </div>\n  <p class=\"basket-list-item__price\">").concat((price * amount).toFixed(2), "</p>\n  <hr class=\"basket-list-item__line\" />\n  <div class=\"basket-list-item__time-delivery\"> \n    <div class=\"checkbox\">\n    <input class=\"custom-checkbox\" type=\"checkbox\" id=\"autoship-").concat(id, "\" name=\"Autoship\" value=\"true\">\n    <label for=\"autoship-").concat(id, "\">Autoship every <div class=\"input-block\">\n  <label class=\"input-block__label\" for=\"time-").concat(id, "\">\n    <select id=\"time-").concat(id, "\" class=\"input-block__select\">\n      <option value=\"15\">15</option>\n      <option value=\"30\">30</option>\n      <option value=\"45\">45</option>\n      <option value=\"60\">60</option>\n    </select>\n  </label>\n  <div class=\"input-block__error\"></div>\n</div>\n days</label>\n  </div>\n  </div>\n</div>"));
  jquery__WEBPACK_IMPORTED_MODULE_0__('.basket-section__product-list').append(newItem);
}
function ChangeItem(id, product) {
  jquery__WEBPACK_IMPORTED_MODULE_0__("#item-".concat(id)).find("#amount-".concat(id)).val(product.amount);
  jquery__WEBPACK_IMPORTED_MODULE_0__("#item-".concat(id)).find('.basket-list-item__price').html((product.amount * product.price).toFixed(2));
}
function updateTotalPrice() {
  var basketArrayString = localStorage.getItem('basketArray');
  if (basketArrayString !== null) {
    var totalPrice = 0;
    var basket = JSON.parse(basketArrayString);
    if (Array.isArray(basket)) {
      basket.forEach(function (element) {
        totalPrice += element.price * element.amount;
      });
      jquery__WEBPACK_IMPORTED_MODULE_0__('.basket-section__footer-button').html(totalPrice.toFixed(2));
    } else {
...
function DeleteItem(id) {
  jquery__WEBPACK_IMPORTED_MODULE_0__("#item-".concat(id)).remove();
  var basketArrayString = localStorage.getItem('basketArray');
  if (basketArrayString !== null) {
    var basket = JSON.parse(basketArrayString);
    if (Array.isArray(basket)) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! jquery */ "./node_modules/jquery/dist/jquery.js");
/* harmony import */ var _stepperInput__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./stepperInput */ "./src/js/modules/stepperInput.js");
/* harmony import */ var _BusketListItem__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./BusketListItem */ "./src/js/modules/BusketListItem.js");
function _typeof(obj) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (obj) { return typeof obj; } : function (obj) { return obj && "function" == typeof Symbol && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }, _typeof(obj); }
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
function _defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, _toPropertyKey(descriptor.key), descriptor); } }
function _createClass(Constructor, protoProps, staticProps) { if (protoProps) _defineProperties(Constructor.prototype, protoProps); if (staticProps) _defineProperties(Constructor, staticProps); Object.defineProperty(Constructor, "prototype", { writable: false }); return Constructor; }
...
var BasketController = /*#__PURE__*/function () {
  function BasketController() {
    _classCallCheck(this, BasketController);
    this.basketContainer = jquery__WEBPACK_IMPORTED_MODULE_0__('#basketContainer');
    this.basketSection = jquery__WEBPACK_IMPORTED_MODULE_0__('.basket-section');
    this.basketList = jquery__WEBPACK_IMPORTED_MODULE_0__('.basket-section__product-list');
    this.htmlElement = jquery__WEBPACK_IMPORTED_MODULE_0__('html');
    this.basketTotalPrice = jquery__WEBPACK_IMPORTED_MODULE_0__('.basket-section__footer-button');
    this.bindEvents();
    this.loadBasketItems();
  }
  _createClass(BasketController, [{
    key: "bindEvents",
    value: function bindEvents() {
      var _this = this;
      jquery__WEBPACK_IMPORTED_MODULE_0__('.header__basket-button').click(function () {
        return _this.showBasket();
      });
      jquery__WEBPACK_IMPORTED_MODULE_0__('#hideBasketButton').click(function () {
        return _this.hideBasket();
      });
      this.basketContainer.click(function () {
        return _this.hideBasket();
      });
      this.basketSection.click(function (event) {
        return _this.stopPropagation(event);
      });
      this.basketList.click(function (event) {
        return _this.elementFunc(event);
      });
    }
  }, {
    key: "showBasket",
    ...
    key: "hideBasket",
    value: function hideBasket() {
      var _this2 = this;
      this.htmlElement.css('overflow', 'auto');
      this.basketContainer.fadeOut(function () {
        return _this2.basketSection.css('right', '-100%');
      });
    }
  }, {
    key: "stopPropagation",
    ...
    key: "elementFunc",
    value: function elementFunc(event) {
      var targetClasses = event.target.classList;
      if (targetClasses.contains('stepper-input__button')) {
        (0,_stepperInput__WEBPACK_IMPORTED_MODULE_1__.AmountInput)(jquery__WEBPACK_IMPORTED_MODULE_0__(event.target));
        this.changeElement(jquery__WEBPACK_IMPORTED_MODULE_0__(event.target).parent()[0].id.replace('stepper-', ''));
        (0,_BusketListItem__WEBPACK_IMPORTED_MODULE_2__.updateTotalPrice)();
      } else if (targetClasses.contains('basket-list-item__delete')) {
        var productId = event.target.getAttribute('id');
        (0,_BusketListItem__WEBPACK_IMPORTED_MODULE_2__.DeleteItem)(productId);
        (0,_BusketListItem__WEBPACK_IMPORTED_MODULE_2__.updateTotalPrice)();
      }
    }
  }, {
    key: "changeElement",
    value: function changeElement(id) {
      var basketArrayString = localStorage.getItem('basketArray');
      if (basketArrayString !== null) {
        var basket = JSON.parse(basketArrayString);
        if (Array.isArray(basket)) {
          basket.forEach(function (element, index) {
            if (element.id === id) {
              var amount = jquery__WEBPACK_IMPORTED_MODULE_0__("#item-".concat(id)).find('.stepper-input__input').val();
              jquery__WEBPACK_IMPORTED_MODULE_0__("#item-".concat(id)).find('.basket-list-item__price').html((amount * element.price).toFixed(2));
              (0,_stepperInput__WEBPACK_IMPORTED_MODULE_1__.AmountInput)(jquery__WEBPACK_IMPORTED_MODULE_0__(event.target).parent());
              jquery__WEBPACK_IMPORTED_MODULE_0__("#item-".concat(id)).find('.basket-list-item__price').html((amount * element.price).toFixed(2));
    ...
    key: "loadBasketItems",
    value: function loadBasketItems() {
      var basketArrayString = localStorage.getItem('basketArray');
      if (basketArrayString !== null) {
        var basket = JSON.parse(basketArrayString);
        if (Array.isArray(basket)) {
          basket.forEach(function (element) {
            (0,_BusketListItem__WEBPACK_IMPORTED_MODULE_2__.AddItemToList)(element.id, element.name, element.price, element.amount, element.img, element.background);
          });
        } else {
          console.error('Ошибка при получении корзины из localStorage');
        }
...
/***/ "./src/js/modules/stepperInput.js":
/*!****************************************!*\
  !*** ./src/js/modules/stepperInput.js ***!
  \****************************************/
/***/ (function(__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   AmountInput: function() { return /* binding */ AmountInput; }
/* harmony export */ });
/* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! jquery */ "./node_modules/jquery/dist/jquery.js");

function AmountInput(obj) {
  var input = obj.siblings('.stepper-input__content').find('.stepper-input__input');
...
new _modules_BurgerMenu__WEBPACK_IMPORTED_MODULE_0__["default"]().init();
document.addEventListener('DOMContentLoaded', function () {
  var swiperContainer = document.querySelector('.what-users-say__swiper-container');
  if (swiperContainer) {
    var mySwiper = new swiper__WEBPACK_IMPORTED_MODULE_1__.Swiper(swiperContainer, {
      slidesPerView: 1,
      spaceBetween: 32,
      breakpoints: {
        600: {
...
document.addEventListener('DOMContentLoaded', function () {
  swiper__WEBPACK_IMPORTED_MODULE_1__.Swiper.use([swiper__WEBPACK_IMPORTED_MODULE_1__.Navigation]);
  var swiperContainer = document.querySelector('.slider-section__swiper-container');
  if (swiperContainer) {
    var mySwiper = new swiper__WEBPACK_IMPORTED_MODULE_1__.Swiper(swiperContainer, {
      navigation: {
        prevEl: '.swiper-button-prev',
